...
tf.app.flags.DEFINE_string('server', 'localhost:8501',
                           'PredictionService host:port')
tf.app.flags.DEFINE_string('image', '/home/yitao/Documents/fun-projects/fun-scripts/test-ssd-tf1/lion.jpg', 'path to image in JPEG format')
